...
- A **.travis.yml** or a [**_YAML_**](https://en.wikipedia.org/wiki/YAML)_ is a simple human readible data serialization configuration file which tells Travis CI what to do once you trigger the build. For example like the one shown below:
